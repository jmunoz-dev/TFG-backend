window.onload = () => {
    ...
    if (/admin\/offers/.test(window.location.href)) {
        ...
        buttonActivate.addEventListener('click', function(event) {
            ...
            let codeAlertOffer = `<div class="codeAlertOffer"><p>La oferta ya se ha activado o ya ha pasado su fecha</p></div>`
...
function createTable(table) {
    ...
    fetch('/api/tables/', {
        ...
        .then(res => {
            ...
            document.forms['add-schedule'].style.display = "flex"
        }).catch(e => console.log(e))
...
function addSchedule(schedule) {
    ...
    fetch('/api/tables/schedule', {
        ...
        .then(res => {
            location.href = "/admin/tables/edit/" + schedule.table.idTable
        }).catch(e => console.log(e))
